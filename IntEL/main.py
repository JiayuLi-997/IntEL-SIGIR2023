...
from models.seqnaive import *
from models.seqensemble import *
from models.learning2rank import *
...
def main():
	...
	# Read data
	if args.drop_mainintent:
		corpus_path = os.path.join(args.datapath, args.dataset, model_name.reader + '_%d%s_dropmain.pkl'%(args.max_session_len,args.noise_note))
	else:
		corpus_path = os.path.join(args.datapath, args.dataset, model_name.reader + '_%d%s.pkl'%(args.max_session_len,args.noise_note))
...
if __name__ == "__main__":
	...
	# collator_name = eval('{0}.SessionCollator'.format(model_name.reader))
